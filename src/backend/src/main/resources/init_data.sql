...
INSERT INTO shop_b2.client(client_name, client_surname, birthday, gender, registration_date, address_id) VALUES
    ('Кэлен', 'Амнелл', '2000-04-05', 'F', '2014-05-06',
        SELECT id FROM shop_b2.address WHERE country = 'Франция', city = 'Леон', street = 'Вьен'),
    ('Йон', 'Тихий', '1940-01-02', 'M', '2024-05-07',
        SELECT id FROM shop_b2.address WHERE country = 'Россия', city = 'Сакт-Петербург', street = 'Лунная'));

INSERT INTO shop_b2.supplier(name, address_id, phone_number) VALUES
    ('Поставщик из Парижу', SELECT id FROM shop_b2.address WHERE country = 'Франция', city = 'Леон', street = 'Вьен'), '+79139139913'),
    ('Поставщик из Петербурга', SELECT id FROM shop_b2.address WHERE country = 'Россия', city = 'Сакт-Петербург', street = 'Лунная'), '+79139139913');
